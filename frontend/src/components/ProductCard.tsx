      ...
      <div className="flex flex-col flex-1 justify-between">
        ...
        <div className="md:hidden flex gap-2 w-full mt-2">
          <button
            ...
            className="flex-1 bg-black text-white py-2 px-1 text-[9px] font-black tracking-wider uppercase rounded-sm flex items-center justify-center gap-1.5 cursor-pointer shadow-sm active:scale-95 transition-all"
          >
            <ShoppingBag size={11} />
            Add to Bag
          </button>
          <button
            ...
            className="flex-1 border border-neutral-300 text-neutral-800 bg-white py-2 px-1 text-[9px] font-black tracking-wider uppercase rounded-sm flex items-center justify-center gap-1 cursor-pointer hover:border-black active:scale-95 transition-all"
          >
            Details
          </button>
        </div>
